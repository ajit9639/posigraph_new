  ...
  <body>
    ...
    <header id="header" class="header-items profile-header">
     <div class="container-fluid">
       <div class="row">
         <div class="col-10 col-xs-10 header-contents">
          <div class="row">
            <div class="col-lg-2 col-2 col-xs-2 go-back">
              <a href="#" title=""><i class="fa-solid fa-arrow-left"></i></a>
            </div>
  ...
  <div class="modal-dialog popup-modal-body" role="document">
    <div class="modal-content sidebar-popup-section">
      ...
      <div class="modal-body">
        ...
        <a href="#" class="text-center modal-links">Privacy Policy</a>
   ...
   <div class="footer">
      <div class="container-fluid">
        <div class="row" id="myDIV">
          ...
          <div class="col-3 col-xs-3 footer-icons">
            <a href="post.php" class="footer-single-icon btn" title="">
