    ...
    while($friends=mysqli_fetch_array($friendList))
    {
        ...
        if($total!=0)
            ...
            echo "
              ...
              <p style='color:cyan;font-size:18px'><a style='color:white;font-size:20px' href='chatApp.php?id=$userId'> $userName <span style='color:yellow' id='unreadOf{$userId}'>$read</span></a> <span><i style='color: $color;font-size: 20px;' class='fa fa-circle' aria-hidden='true'></i>$flag</span></p> </div> <hr>";
