  ...
  <div class="w3-row">
    ...
    <div class="w3-col m7">
      ...
      <div  class="w3-container w3-card w3-white w3-round w3-margin"><br>
        ...
        <button id="comment-btn" type="button" class="comment-btn w3-button w3-theme-d2 w3-margin-bottom"><i class="fa fa-comment"></i> &nbsp;Comment</button> 
      </div>       
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
        ...
        <button type="button" class="w3-button w3-theme-d1 w3-margin-bottom"><i class="fa fa-thumbs-up"></i> &nbsp;Like</button> 
        <button type="button" class=" comment-btn w3-button w3-theme-d2 w3-margin-bottom"><i class="fa fa-comment"></i> &nbsp;Comment</button> 
      </div>
