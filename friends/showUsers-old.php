                ...
                echo"
                    ...
                    <div class='col-sm-12 user-detail'>
                        ...
                        <div class='col-sm-7 user-name-buttons'> 
                             ...
                             <div class=' row name'>
                                  <a href='https://posigraph.com/ajit/profile/profile.php?id={$row['receiverId']}'><p style='margin:10px 10px;'>{$receiverNameDp['firstName']}</p>
                                  </a>
                             </div>
                     ...
                     <div class='col-sm-12 user-detail'>
                           ...
                           <div class='col-sm-4 user-pic'> 
                            ...
                            <div class='col-sm-7 user-name-buttons'>
                                    ...
                                    <div class='row name'>
                                      <a href='https://posigraph.com/ajit/profile/profile.php?id={$row['senderId']}'><p style='margin:10px 10px;'>{$senderNameDp['firstName']}</p>
                                       </a>
                                    </div>
                     ...
                     $query="select userId,firstName ,dp from user where userId={$row['userTwo']}";
                      ...
                      echo"
                          <div class='col-sm-12 user-detail'>
                                ...
                                <div class='col-sm-7 user-name-buttons'> 
                                    <div class='row name'><a href='https://posigraph.com/ajit/profile/profile.php?id={$friend['userId']}'><p style='color:white;margin:10px 10px;'>{$friend['firstName']}</p></a></div>
                ...
                echo"
                    ...
                    <div class='col-sm-12 user-detail'>
                        ...
                        <div class='col-sm-7 user-name-buttons'> 
                             ...
                             <div class=' row name'>
                                  <a href='https://posigraph.com/ajit/profile/profile.php?id={$row['userId']}'><p style='margin:10px 10px;'>{$row['firstName']}</p></a>
                             </div>
