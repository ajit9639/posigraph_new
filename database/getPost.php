...
//                    <!--         post area start-->
                    ...
                    { ?>
                       ...
                       <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
                            <img src="dp/<?php echo $user['dp']?>" alt="Avatar4" class="w3-left w3-circle w3-margin-right" style="width:100px;border-radius:50%;">
                             <a href="./profile/profile.php?id=<?php echo $list['userId']?>">   
                 ...
                 <div class="mt-2">
        <button type="button" data-pid="<?php echo $list['postId']?>"  class="like-btn w3-button w3-theme-d1 w3-margin-bottom btn btn-success"><i style="color:<?php echo $color?>" id="<?php echo $list['postId']?>" class="fa fa-thumbs-up"></i> &nbsp;<span id="like<?php echo $list['postId']?>"><?php totalLike($list['postId']);?></span></button>
                           
        <button  type="button" data-pid="<?php echo $list['postId']?>" class="comment-btn w3-button w3-theme-d2 w3-margin-bottom btn btn-info"><i class="fa fa-comment"></i> &nbsp;Comment</button>
                       </div> 
                       </div>          
